        ...
        {!searchRecipeOn ? (
          <>
            ...
            <div className="container-fluid mx-0 p-0 homeMainContainer">
              <div className="container">
                <div
                  className="row me-0 pe-0 ms-0 ps-0"
                  style={{ height: "100%" }}
                >
                  <div
                      ...
                      <div className="col-sm-6 col-12 rightSide d-flex align-items-center">
                        <div>
                          ...
                          <div className="slogan">
                            <p>
                              Are you looking for the latest cooking recipes?
                              This is for you. Let's learn and start cooking.
                            </p>
                          </div>
                          {/* BUTTON LEARN */}
              ...
              <div className="row title">
                <div className="col-12 d-flex justify-content-center">
                  <div>
                    <h1>All Recipes</h1>
                    <p>
                      All recipes are here. Find simple, delicious and fast
                      recipes.
                    </p>
                  </div>
                </div>
          ...
          <>
            <div
              ...
              style={{ backgroundColor: "#ffd9a55e" }}
            >
              <div className="container searchPage">
                ...
                <div className="row title">
                  <div className="col-12 d-flex justify-content-center position-relative">
                    ...
                    <div className="position-absolute iconClose">
                      <CloseIcon
                        className="icon"
                        onClick={() => {
                          setSearchRecipeOn(false);
                ...
                <div className="row searchForm">
                  <div className="col-12">
                    ...
                    <div className="textSearch d-flex justify-content-center">
                      <p>Search Results from : </p>
                      <p className="ms-1 searchInput">{searchRecipe}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="row allRecipes">
                  ...
                  {recipeNotFound && !isLoading ? (
                    <h2 className="d-flex justify-content-center mt-5 mb-sm-5">
                      Recipe not found
                    </h2>
                  ) : null}
                  {!isLoading && !recipeNotFound
                    ? recipeSearch.map((item, key) => {
                        return (
                          <div className="col-sm-3 col-6" key={key}>
                            <AllRecipe
                              image={item?.picture}
